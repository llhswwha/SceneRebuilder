    ...
    {
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("enableWssOffer"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("startOnAwake"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("bitrateInfo"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("framerateInfo"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("scaleResoluton"));
