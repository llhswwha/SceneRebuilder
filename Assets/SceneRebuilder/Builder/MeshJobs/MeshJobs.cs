...
namespace MeshJobs
{
    ...
    public static class MeshJobHelper
    {
        ...
        public static Dictionary<Transform, Transform> GetParentDict(MeshPoints[] meshFilters)
        {
            ...
            {
                MeshPoints meshFilter = meshFilters[i];
                if (parentDict.ContainsKey(meshFilter.transform))
                {
                    Debug.LogError($"GetParentDict parentDict.ContainsKey(meshFilter.transform) i:{i} meshFilters:{meshFilters.Length} meshFilter:{meshFilter}");
                }
                else
                {
