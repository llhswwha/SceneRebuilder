...
public static class Math3D  {
	...
	public static float DistanceToLine(Vector3 linePoint, Vector3 lineVec, Vector3 point)
	{
		...
		//Vector3 lineP= linePoint + lineVec * t;

		Vector3 lineP = ProjectPointOnLine(linePoint, lineVec, point);
