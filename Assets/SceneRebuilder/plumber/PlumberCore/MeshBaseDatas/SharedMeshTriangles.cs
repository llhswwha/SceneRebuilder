...
public class SharedMeshTrianglesList : List<SharedMeshTriangles>
{
    ...
    public static SharedMeshTrianglesList GetList(MeshStructure mesh)
    {
        ...
        SharedMeshTrianglesList trianglesList = meshTriangles.GetSharedMeshTrianglesListById(sharedMinCount, minRepeatPointDistance, "GetList");
    ...
    public List<PlanePointDistance> GetPlanePointDistanceList()
    {
        ...
        var centerOfPoints = this.GetCenter();
    ...
    public void CombineSameCenter(float minDis,bool isCombine=true)
    {
        int count1 = this.Count;
    ...
    public SharedMeshTriangles GetPlaneByNormal(Vector3 vector3,float minZero)
    {
        foreach (var item in this)
        {
    ...
    public SharedMeshTriangles GetClosedPlaneByNormal(Vector3 vector3, float minZero)
    {
        foreach (var item in this)
        {
            if (item.Normal == vector3)
