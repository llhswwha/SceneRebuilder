...
public class VerticesToPointInfo : IComparable<VerticesToPointInfo>
{
    ...
    public VerticesToPointInfo(Vector3[] vs, Vector3 p, bool isShowLog)
    {
        Point = p;
    ...
    public int CompareTo(VerticesToPointInfo other)
    {
