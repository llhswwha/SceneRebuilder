...
public class ModelBuildingScript : MonoBehaviour
{
    ...
    internal ModelLevelScript GetLevel(string lvName)
    {
        for (int i = 0; i < Levels.Count; i++)
        {
            ModelLevelScript item = Levels[i];
    ...
    private void CombineLevel(string levelName1,string levelName2, bool isEqual)
    {
    ...
    internal void CombineLevel(string sceneName)
    {
