...
public class MeshNodeEditor : InnerMeshNodeEditor
{
    ...
    //public override void OnToolLayout(InnerMeshNode innerItem)
    //{
    //    MeshNode item = innerItem as MeshNode;
    ...
    //                if (node.sharedMeshInfos != null)
    //                {
    //                    arg.caption = $"[{i:00}] {node.GetName()} ({node.GetMeshNodes().Count}|{node.sharedMeshInfos.Count})";
    //                }
    //                else
    //                {
