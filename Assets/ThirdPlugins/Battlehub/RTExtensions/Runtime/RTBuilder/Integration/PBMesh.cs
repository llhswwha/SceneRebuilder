...
namespace Battlehub.ProBuilderIntegration
{
    ...
    public class PBMesh : MonoBehaviour
    {
        ...
        private static void ImportMesh(MeshFilter filter, ProBuilderMesh mesh, Vector2 uvScale)
        {
            ...
            {
                Debug.LogWarning("ImportMesh filter.sharedMesh==null");
                return ;
            }
            //ProBuilder 4.2
            ...
            //ProBuilder >4.3 public MeshImporter(Mesh sourceMesh, Material[] sourceMaterials, ProBuilderMesh destination)
            Renderer renderer = mesh.GetComponent<Renderer>();
            MeshImporter importer = new MeshImporter(filter.sharedMesh,renderer.sharedMaterials,mesh);
            importer.Import(m_defaultImportSettings);//public void Import(MeshImportSettings importSettings = null)
