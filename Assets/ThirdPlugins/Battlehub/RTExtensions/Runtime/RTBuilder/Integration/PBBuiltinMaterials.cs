...
namespace Battlehub.ProBuilderIntegration
{
    public static class PBBuiltinMaterials
    {
        ...
        public static Material DefaultMaterial
        {
            get
            {
                // Debug.Log("DefaultMaterial1");
                if(GraphicsSettings.renderPipelineAsset == null)
                {
                    // Debug.Log("DefaultMaterial21");
                    return BuiltinMaterials.defaultMaterial;
                }
                else
                {
                    // Debug.Log("DefaultMaterial22");
                    if(m_defaultMaterial == null)
                    {
                        Type pipelineType = GraphicsSettings.renderPipelineAsset.GetType();
                        Debug.Log("pipelineType:"+pipelineType);
                        ...
                        Debug.Log("m_defaultMaterial:"+m_defaultMaterial);

                        // BuiltinMaterials.defaultMaterial=m_defaultMaterial;
                    }
                    // Debug.Log("DefaultMaterial3");
