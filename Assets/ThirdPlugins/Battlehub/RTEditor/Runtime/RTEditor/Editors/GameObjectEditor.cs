...
namespace Battlehub.RTEditor
{
    public class GameObjectEditor : MonoBehaviour
    {
        ...
        private void Awake()
        {
            // Debug.Log("GameObjectEdior.Awake Start");
            ...
            {
                // Debug.Log("GameObjectEdior.Awake AfterLoadLayers Start");
                ...
                // Debug.Log("GameObjectEdior.Awake AfterLoadLayers End");
            });

            // Debug.Log("GameObjectEdior.Awake End");
        }
        ...
        {
            // Debug.Log("GetComponentGroups Start:"+gameObjects.Length);
            ...
            // Debug.Log("GetComponentGroups End:"+groups.Count);      
            return groups;
        }
        ...
        {
            // Debug.Log("CreateComponentEditor start:"+components.Count);
            ...
            if (m_editorsMap.IsObjectEditorEnabled(componentType))
            {
                ...
                if (editorPrefab != null)
                {
                    ...
                    {
                        // Debug.Log("CreateComponentEditor 31");
                        ...
                        // Debug.Log("CreateComponentEditor end true:"+components.Count);
                        return true;
                    }
                    else
                    {
                        // Debug.Log("CreateComponentEditor 32");
                        Debug.LogErrorFormat("editor prefab {0} does not have ComponentEditor script", editorPrefab.name);
                        return false;
                    }
                }
            }
            // Debug.Log("CreateComponentEditor end false1");
            return false;
        }
