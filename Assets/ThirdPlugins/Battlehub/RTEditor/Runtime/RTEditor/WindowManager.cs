...
namespace Battlehub.RTEditor
{
    ...
    public static class IWindowManagerExt
    {
        ...
        public static LayoutInfo GetBuiltInDefaultLayout(this IWindowManager wm)
        {
            ...
            //             wm.CreateLayoutInfo(gameContent.transform, gameWd.Header, gameWd.Icon),
            //             0.75f);
            // LayoutInfo layout2=new LayoutInfo(true,
            //             wm.CreateLayoutInfo(inspectorContent.transform, inspectorWd.Header, inspectorWd.Icon),
            //             wm.CreateLayoutInfo(probuilderContent.transform, probuilderWd.Header, probuilderWd.Icon),
            //             0.75f);
            // LayoutInfo layout = new LayoutInfo(false,layout2,layout1,0.25f);
...
#pragma warning disable CS0612
        ...
        {
            Debug.Log("InitActiveWorkspace_Internal Start");
            ...
            Debug.Log("InitActiveWorkspace_Internal End");
        }
#pragma warning restore

        private void Start()
        {
            Debug.Log("WindowManager.Start Start");
            ...
            Debug.Log("WindowManager.Start End");
        }
