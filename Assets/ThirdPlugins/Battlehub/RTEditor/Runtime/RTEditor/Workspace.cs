...
namespace Battlehub.RTEditor
{
    public class Workspace : MonoBehaviour
    {
        ...
        {
            Debug.Log("Workspace.SetDefaultLayout Start");
            ...
            Debug.Log("Workspace.SetDefaultLayout End");
        }
        ...
        public Transform CreateWindow(string windowTypeName, out WindowDescriptor wd, out GameObject content, out bool isDialog)
        {
            ...
            {
                Debug.LogWarningFormat("{0} wd.Created >= wd.MaxWindows {1}>={2}", windowTypeName,wd.Created,wd.MaxWindows);
                return null;
            }
            wd.Created++;
            ...
            if (wd.ContentPrefab != null)
            {
                ...
                for (int i = 0; i < children.Length; ++i)
                {
                    ...
                    {
                        // Debug.LogError("m_extraComponents.Add :"+component+"|"+m_componentsRoot);
        ...
        {
            RectTransform rect = (RectTransform)testWindow.transform;
            Vector3 p = Input.GetPointerXY(0);
            Camera c = Raycaster.eventCamera;
            return RectTransformUtility.RectangleContainsScreenPoint(rect, p, c);
        }
        ...
        public LayoutInfo GetLayout(string name)
        {
            ...
            Debug.LogError("GetLayout:["+"Battlehub.RTEditor.Layout" + name+"]\txml:"+serializedLayout);
        ...
        private void OnTabActivated(Region region, Transform content)
        {
            ...
            if (m_extraComponents.TryGetValue(content, out extraComponents))
            {
                for (int i = 0; i < extraComponents.Count; ++i)
                {
                    ...
                    Debug.Log("OnTabActivated:"+content+"|"+extraComponent);
