...
namespace Battlehub.RTHandles
{
    ...
    public class RuntimeSelectionComponent : RTEComponent, IRuntimeSelectionComponent
    {
        ...
        protected override void Awake()
        {
            ...
            ComponentId=ID++;
            Debug.Log("RuntimeSelectionComponent.Awake SceneId:"+ComponentId+"|"+lastComponent);
            ...
            if (m_pivot == null)
            {
                ...
                pivot.transform.position = InitPivotPos;
            ...
            if (m_secondaryPivot == null)
            {
                ...
                secondaryPivot.transform.position = InitPivotPos;
        ...
        public virtual void SelectGO(bool multiselect, bool allowUnselect)
        {
            ...
            else
            {
                ...
                {
                    Renderer[] renderers = m_boxSelection != null&&m_boxSelection.enabled ? m_boxSelection.Pick() : new Renderer[0];
        ...
        private bool _allowUnSelectObj=true;

        public void SetAllowUnSelect(bool isOn)
        {
            _allowUnSelectObj = isOn;
        }
        [ContextMenu("TryToClearSelection")]
        public void TryToClearSelection(bool ignoreUnSelect=false)
        {
            if (!_allowUnSelectObj&&!ignoreUnSelect) return;
            UnityObject[] filteredSelection;
        ...
        private void HandleRuntimeSelectionChange(IRuntimeSelection selection, UnityObject[] unselected)
        {
            ...
            if (selected != null)
            {
                for (int i = 0; i < selected.Length; ++i)
                {
                    ...
                    if (exposeToEditor && !selectedObj.IsPrefab() && !BaseHandle.GetIsStatic(selectedObj))
                    {
        ...
        //[SerializeField]
        private int _selectableLayers = 1342177736;//Default select layer-Range
        ...
        {
            //bool can=!m_canSelectExposedOnly || go.GetComponentInParent<ExposeToEditor>();
            ...
            bool can = LayerHelper.IsLayerBitSet(SelectableLayers, go.layer);
            //if(!can)can= go.GetComponentInParent<ExposeToEditor>();
            return can;
        }
