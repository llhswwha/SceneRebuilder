...
namespace Battlehub.UIControls.MenuControl
{
    ...
    public class MenuCreator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Debug.Log("MenuCreator.Awake menus:"+menus.Length);
            for(int i = 0; i < menus.Length; ++i)
            {
                // Debug.Log("  menus:"+menus[i].name);
            ...
            foreach (Type menuDef in menuDefinitions)
            {
                ...
                for (int i = 0; i < methods.Length; ++i)
                {
                    ...
                    {
                        // Debug.Log("      cmd == null || string.IsNullOrEmpty(cmd.Path)");
                        continue;
                    }
                    ...
                    if(cmd.RequiresInstance)
                    {
                        ...
                        {
                            // Debug.Log("      FindObjectOfType(menuDef) == null");
                            continue;
                        }
                    }
                    Debug.Log("cmd:"+cmd.Path);
        ...
        {
            Debug.Log("_CreateMenu:"+menuName);
