...
namespace GPUInstancer
{
    public abstract class GPUInstancerManager : MonoBehaviour
    {
        ...
        public GPUInstancerRuntimeDataDictList runtimeDataDictList = new GPUInstancerRuntimeDataDictList();

        public List<GPUInstancerRuntimeData> runtimeDataList
        {
            get
            {
                if (runtimeDataDictList == null) return null;
                return runtimeDataDictList.runtimeDataList;
            }
        }
        ...
        public virtual void OnEnable()
        {
            ...
            if (SystemInfo.supportsComputeShaders)
            {
                ...
                if (runtimeDataDictList.Count==0)
        ...
        {
            GPUInstancerUtility.ReleaseInstanceBuffers(runtimeDataDictList.runtimeDataList);
        ...
        public virtual void RemoveInstancesInsideBounds(Bounds bounds, float offset, List<GPUInstancerPrototype> prototypeFilter = null)
        {
            ...
            runtimeDataDictList.RemoveInstancesInsideBounds(bounds, offset, prototypeFilter);
        }
        public virtual void RemoveInstancesInsideCollider(Collider collider, float offset, List<GPUInstancerPrototype> prototypeFilter = null)
        {
            ...
            runtimeDataDictList.RemoveInstancesInsideCollider(collider, offset, prototypeFilter);
        }
        ...
        public void SetLODBias(float newLODBias, List<GPUInstancerPrototype> prototypeFilter)
        {
            ...
            runtimeDataDictList.SetLODBias(newLODBias, prototypeFilter);
        }
        ...
        public void UpdateTreeMPB()
        {
            if (treeProxyList != null && treeProxyList.Count > 0)
            {
                ...
                foreach (GPUInstancerRuntimeData runtimeData in runtimeDataDictList.runtimeDataList)
                {
        ...
        public GPUInstancerRuntimeData GetRuntimeData(GPUInstancerPrototype prototype, bool logError = false)
        {
            ...
            if (!runtimeDataDictList.runtimeDataDictionary.TryGetValue(prototype, out runtimeData) && logError)
