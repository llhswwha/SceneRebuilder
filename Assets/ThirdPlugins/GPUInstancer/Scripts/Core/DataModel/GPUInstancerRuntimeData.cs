...
namespace GPUInstancer
{
    public class GPUInstancerRuntimeData
    {
        ...
        public bool IsLODShadowCasting(int lodLevel)
        {
            ...
            if(prototype.shadowLODMap.Length-1<lodIndex)
            {
                return false;
            }
        ...
        public void UpdateTransform(List<GPUInstancerPrefab> prefabInstanceList)
        {
            ...
            foreach (GPUInstancerPrefab prefabInstance in prefabInstanceList)
            {
                ...
                if (instanceTransform.hasChanged && prefabInstance.state == PrefabInstancingState.Instanced)
                {
                    ...
                    this.instanceDataArray[prefabInstance.gpuInstancerID - 1] = instanceTransform.localToWorldMatrix;
                    this.transformDataModified = true;
                }
            }
        }
    }

    public class GPUInstancerRuntimeDataDictList
    {
        ...
        public GPUInstancerRuntimeData AddPrototype(GPUInstancerPrefabPrototype p)
        {
            GPUInstancerRuntimeData runtimeData = new GPUInstancerRuntimeData(p);
        ...
        public void RemovePrototype(GPUInstancerRuntimeData runtimeData)
        {
        ...
        public void RemoveInstancesInsideBounds(Bounds bounds, float offset, List<GPUInstancerPrototype> prototypeFilter = null)
        {
            if (runtimeDataList != null)
            {
        ...
        public void RemoveInstancesInsideCollider(Collider collider, float offset, List<GPUInstancerPrototype> prototypeFilter = null)
        {
            if (runtimeDataList != null)
            {
                foreach (GPUInstancerRuntimeData rd in runtimeDataList)
