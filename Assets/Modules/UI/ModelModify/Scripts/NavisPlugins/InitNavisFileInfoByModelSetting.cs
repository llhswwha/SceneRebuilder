...
public class InitNavisFileInfoByModelSetting : SingletonBehaviour<InitNavisFileInfoByModelSetting>
{
    ...
    public static List<string> FilterNames3_Default = new List<string>() { "合成部分", "Bounds","Node_" };//Contains,"_OutTree","_Out0Tree"
    ...
    public static List<string> filterStructureModelParents_Default = new List<string>() {"Pile", "Slab" };//一幢大楼的窗户被我们按楼层拆掉了。
