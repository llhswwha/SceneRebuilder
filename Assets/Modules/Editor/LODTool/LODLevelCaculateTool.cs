...
{
    /// <summary>
    /// 展示类型 （GameView||SceneView）
    /// </summary>
    public enum LODSceneView
    {
        GameView,
        SceneView
    }
    public enum LODSortType
    {
        Vertex,
        Mesh,
    }
    public class LODGroupDetails
    {
        ...
        public string GetVertexString()
        {
            ...
            else
            {
                ...
                return string.Format("{0}({1}%)", currentChild.vertexCount, percent);
            }
        }
        /// <summary>
        /// mesh个数占比
...
public class LODLevelCaculateTool : EditorWindow
{
    ...
    private void GetSceneLodGroupInfo()
    {
        ...
        lodInfos = new List<LODGroupDetails>();
