...
namespace AdvancedCullingSystem.StaticCullingCore
{
    public class Caster : MonoBehaviour
    {
        ...
        public bool AddNewRenderer(MeshRenderer renderer)
        {
            if (!_visibleRenderers.Contains(renderer))
            {
                _visibleRenderers.Add(renderer);
                //Debug.LogError($"AddNewRenderer renderer:{renderer}");
                return true;
            }
            return false;
        }
        ...
        public static bool IsFirstDebug = true;
        ...
        public void PushData()
        {
            ...
            {
                IsFirstDebug = false;
                Debug.LogError("Caster.PushData");
            }
